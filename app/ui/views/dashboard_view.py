...
class MetricCard(QFrame):
    ...
    def __init__(self, title: str, value: str, subtitle: str, color: str = "#89B4FA", parent: QWidget = None) -> None:
        ...
        v_label.setStyleSheet("color: #CDD6F4; font-size: 20px; font-weight: bold;")
...
class DashboardView(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        # Overview Box
        overview_group = QGroupBox("System & Integration Status", self)
        overview_layout = QVBoxLayout(overview_group)

        self.info_text = QLabel(
            "• Welcome to DaVinci PiloT Milestone 1 (Project Foundation).\n"
            "• The desktop environment is running cleanly in PySide6 with MVVM architecture.\n"
            "• Next Milestone (Milestone 2): DaVinci Resolve Connection & Scripting API Bridge.",
            self
        )
